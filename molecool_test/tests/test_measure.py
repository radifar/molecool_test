...
def test_calculate_distance():
    ...
    calculated_distance = molecool_test.calculate_distance(r1, r2)
...
def test_calculate_angle():
   ...
   calculated_value = molecool_test.calculate_angle(r1, r2, r3, degrees=True)
...
def test_calculate_angle_many(p1, p2, p3, expected_angle):
    ...
    calculated_angle = molecool_test.calculate_angle(p1, p2, p3, degrees=True)
